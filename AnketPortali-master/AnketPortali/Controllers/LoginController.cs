...
namespace AnketPortali.Controllers
{
    public class LoginController : Controller
    {
        ...
        public LoginController(ILogger<HomeController> logger, INotyfService notify, UserManager<AppUser> userManager, RoleManager<AppRole> roleManager, SignInManager<AppUser> signInManager)
        {
            _logger = logger;
